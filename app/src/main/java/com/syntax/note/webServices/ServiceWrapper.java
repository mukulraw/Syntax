...
import com.syntax.note.BuildConfig;
...
//            HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor();
    ...
    /* body = new signupRequestBean();


    public Call<signupResponseBean> newSignup() {
        return mServiceInterface.signup(signupRequestBean);
